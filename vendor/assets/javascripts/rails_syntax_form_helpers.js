...
// unfinished for comma insertion
// FormHelpers.prototype.currency_text_field_tag = function(name, value, html_options, money_options) {
//   html_options = html_options || {};
//   money_options = money_options || {};

//   if (value === '' || value === null || value === undefined) {
//     return this.text_field_tag(name, value, html_options)
//   } else {
//     var precision = money_options['precision'] || 2
//     if (money_options.unit === undefined || money_options.unit === null || money_options.unit === true) {
//       money_options.unit = '$'
//     } else if (money_options.unit === false) {
//       money_options.unit = ''
//     }
//     // var delimiter = money_options['delimiter'] || ','
//     // var separator = money_options['separator'] || '.'

//     var money_string = money_options.unit + parseFloat(value).toFixed(precision).toString()
//     return this.text_field_tag(name, money_string, html_options)
//   }
// }
...
FormHelpers.prototype.input_field_tag = function(name, value , inputType, html_options) {
  ...
  html_options.value = value || (value === 0 ? '0' : '');
...
FormHelpers.prototype.submit_link_to = function(name, url, html_options){
  ...
  html_options.value = name || (name === 0 ? '0' : '');
...
FormHelpers.prototype.select_tag = function(name, options_for_select, html_options) {
  ...
  if (_.isDefined(html_options.prompt) && html_options.prompt != false) {
...
FormHelpers.prototype.submit_tag = function(name, html_options) {
  ...
  html_options.value = name || (name === 0 ? '0' : 'Submit');
  return this.single_tag_for('input', html_options);
}
